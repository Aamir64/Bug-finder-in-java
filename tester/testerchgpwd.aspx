<%@ Page Language="C#" MasterPageFile="~/tester/testerMasterPage.master" AutoEventWireup="true" CodeFile="testerchgpwd.aspx.cs" Inherits="tester_testerchgpwd" Title="Untitled Page" %>
...
<td style="background-color: #e9e9e9"><%--<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="*" ControlToValidate="txtoldpwd"></asp:RequiredFieldValidator>--%>
