<%@ Page Language="C#" MasterPageFile="~/projectmanager/MasterPage.master" AutoEventWireup="true" CodeFile="statuslist.aspx.cs" Inherits="projectmanager_statuslist" Title="Untitled Page" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating">
    ...
    <ItemTemplate>
    <asp:Label ID="Label1" runat="server" Text='<%#Eval("status_id")%>'></asp:Label>
    </ItemTemplate>
    <EditItemTemplate>
    <asp:Label ID="lblid" runat="server" Text='<%#Eval("status_id")%>'></asp:Label>
    </EditItemTemplate>
    </asp:TemplateField>
    ...
    <EditItemTemplate>
        <asp:TextBox ID="txtname" runat="server" Text='<%#Eval("status")%>'></asp:TextBox>
    </EditItemTemplate>
    </asp:TemplateField>
