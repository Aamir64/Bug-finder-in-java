<%@ Page Language="C#" MasterPageFile="~/projectmanager/MasterPage.master" AutoEventWireup="true" CodeFile="edittester.aspx.cs" Inherits="projectmanager_edittester" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<table>
<tr>
<td align="center" style="background-color:#ff9933;font-size:16px;font-weight:bolder;">Tester Details&nbsp;
...
<%#Container.DataItemIndex+1 %>
 ...
 <%#Container.DataItemIndex+1 %>
  ...
  <ItemTemplate>
  <asp:Label ID="Label11" runat="server" Text='<%#Eval("tester_id")%>'></asp:Label>
  </ItemTemplate>
  <EditItemTemplate>
   <asp:Label ID="lblid" runat="server" Text='<%#Eval("tester_id")%>'></asp:Label>
  </EditItemTemplate>
  </asp:TemplateField>
  <asp:TemplateField HeaderText="Tester Name">
  <ItemTemplate>
      <asp:Label ID="Label2" runat="server" Text='<%#Eval("tester_name")%>'></asp:Label>
  </ItemTemplate>
  <EditItemTemplate>
  <asp:TextBox ID="txtname" runat="server" Text='<%#Eval("tester_name")%>'></asp:TextBox>
  </EditItemTemplate>
  </asp:TemplateField>
